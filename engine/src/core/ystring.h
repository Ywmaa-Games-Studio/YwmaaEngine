 ...
 */
YAPI u32 string_utf8_length(const char* str);
 ...
 */
YAPI b8 bytes_to_codepoint(const char* bytes, u32 offset, i32* out_codepoint, u8* out_advance);
 ...
 */
YAPI void string_free(char* str);
...
YAPI b8 strings_equali(const char* str0, const char* str1);
 ...
 * @return True if the same, otherwise false.
 */
YAPI b8 strings_nequali(const char* str0, const char* str1, u64 length);

// Performs string formatting to dest given format string and parameters.
YAPI i32 string_format(char* dest, const char* format, ...);
...
YAPI char* string_ncopy(char* dest, const char* source, i64 length);

YAPI char* string_trim(char* str);

YAPI void string_mid(char* dest, const char* source, i32 start, i32 length);
 ...
 */
YAPI b8 string_to_transform(const char* str, Transform* out_transform);
 ...
 */
YAPI u32 string_split(const char* str, char delimiter, char*** str_darray, b8 trim_entries, b8 include_empty);
 ...
 */
YAPI void string_cleanup_split_array(char** str_darray);
 ...
 */
YAPI void string_append_string(char* dest, const char* source, const char* append);
 ...
 */
YAPI void string_append_int(char* dest, const char* source, i64 i);
 ...
 */
YAPI void string_append_float(char* dest, const char* source, f32 f);
 ...
 */
YAPI void string_append_bool(char* dest, const char* source, b8 b);
 ...
 */
YAPI void string_append_char(char* dest, const char* source, char c);
 ...
 */
YAPI void string_directory_from_path(char* dest, const char* path);
 ...
 * @param path The full path to extract from.
 */
YAPI void string_filename_from_path(char* dest, const char* path);
