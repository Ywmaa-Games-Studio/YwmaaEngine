 ...
 */
YINLINE Vector3 Vector3_transform(Vector3 v, Matrice4 m) {
    Vector3 out;
 ...
 */
YINLINE f32 range_convert_f32(f32 value, f32 old_min, f32 old_max, f32 new_min, f32 new_max) {
 ...
 */
YINLINE void rgbu_to_u32(u32 r, u32 g, u32 b, u32* out_u32) {
 ...
 */
YINLINE void u32_to_rgb(u32 rgbu, u32* out_r, u32* out_g, u32* out_b) {
    *out_r = (rgbu >> 16) & 0x0FF;
    *out_g = (rgbu >> 8) & 0x0FF;
    *out_b = (rgbu)&0x0FF;
}
...
/**
 * @brief Converts rgb integer values [0-255] to a Vector3 of floating-point values [0.0-1.0]
 * 
 * @param r The red value [0-255].
 * @param g The green value [0-255].
 * @param b The blue value [0-255].
 ...
 */
YINLINE void rgb_u32_to_Vector3(u32 r, u32 g, u32 b, Vector3* out_v) {
    out_v->r = r / 255.0f;
    out_v->g = g / 255.0f;
    out_v->b = b / 255.0f;
}
...
/**
 * @brief Converts a Vector3 of rgbvalues [0.0-1.0] to integer rgb values [0-255].
 * 
 ...
 * @param out_b A pointer to hold the blue value.
 */
YINLINE void Vector3_to_rgb_u32(Vector3 v, u32* out_r, u32* out_g, u32* out_b) {
    *out_r = v.r * 255;
    *out_g = v.g * 255;
    *out_b = v.b * 255;
}
