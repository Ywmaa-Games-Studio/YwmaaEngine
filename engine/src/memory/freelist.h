 ...
 */
  ...
  */
 YAPI void freelist_create(u64 total_size, u64* memory_requirement, void* memory, FREELIST* out_list);
  ...
  */
 YAPI void freelist_destroy(FREELIST* list);
  ...
  */
 YAPI b8 freelist_allocate_block(FREELIST* list, u64 size, u64* out_offset);
  ...
  */
 YAPI b8 freelist_free_block(FREELIST* list, u64 size, u64 offset);
 ...
 */
YAPI b8 freelist_resize(FREELIST* list, u64* memory_requirement, void* new_memory, u64 new_size, void** out_old_memory);
  ...
  */
 YAPI void freelist_clear(FREELIST* list);
  ...
  */
 YAPI u64 freelist_free_space(FREELIST* list);