    ...
    if (!fence->is_signaled) {
        ...
        switch (result) {
            ...
            case VK_ERROR_DEVICE_LOST:
                PRINT_ERROR("vk_fence_wait - VK_ERROR_DEVICE_LOST.");
                break;
            case VK_ERROR_OUT_OF_HOST_MEMORY:
                PRINT_ERROR("vk_fence_wait - VK_ERROR_OUT_OF_HOST_MEMORY.");
                break;
            case VK_ERROR_OUT_OF_DEVICE_MEMORY:
                PRINT_ERROR("vk_fence_wait - VK_ERROR_OUT_OF_DEVICE_MEMORY.");
                break;
            default:
                PRINT_ERROR("vk_fence_wait - An unknown error has occurred.");
                break;
        }
    } else {
