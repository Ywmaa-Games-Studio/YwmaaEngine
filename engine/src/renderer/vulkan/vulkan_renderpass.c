...
void vulkan_renderpass_begin(
    ...
    if (do_clear_colour) {
        ycopy_memory(clear_values[begin_info.clearValueCount].color.float32, renderpass->clear_colour.elements, sizeof(f32) * 4);
...
#pragma clang optimize on // Disable optimizations here because sometimes they cause damage by removing important zeroed variables
