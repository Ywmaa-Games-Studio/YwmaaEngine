...
b8 webgpu_swapchain_create(WEBGPU_CONTEXT* context,
    ...
    config.presentMode = context->flags & RENDERER_CONFIG_FLAG_VSYNC_ENABLED_BIT ? WGPUPresentMode_Fifo : WGPUPresentMode_Fifo; // WGPUPresentMode_Immediate; #TODO: Immediate is not available in this WebGPU Lib
