...
YAPI b8 simple_scene_directional_light_add(SIMPLE_SCENE* scene, const char* name, struct DIRECTIONAL_LIGHT* light);

YAPI b8 simple_scene_point_light_add(SIMPLE_SCENE* scene, const char* name, struct POINT_LIGHT* light);

YAPI b8 simple_scene_mesh_add(SIMPLE_SCENE* scene, const char* name, struct Mesh* m);

YAPI b8 simple_scene_skybox_add(SIMPLE_SCENE* scene, const char* name, struct Skybox* sb);

YAPI b8 simple_scene_directional_light_remove(SIMPLE_SCENE* scene, const char* name);

YAPI b8 simple_scene_point_light_remove(SIMPLE_SCENE* scene, const char* name);

YAPI b8 simple_scene_mesh_remove(SIMPLE_SCENE* scene, const char* name);

YAPI b8 simple_scene_skybox_remove(SIMPLE_SCENE* scene, const char* name);
