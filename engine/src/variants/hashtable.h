 ...
 */
YAPI void hashtable_create(u64 element_size, u32 element_count, void* memory, b8 is_pointer_type, HASHTABLE* out_hashtable);
 ...
 */
YAPI void hashtable_destroy(HASHTABLE* table);
 ...
 */
YAPI b8 hashtable_set(HASHTABLE* table, const char* name, void* value);
 ...
 */
YAPI b8 hashtable_set_ptr(HASHTABLE* table, const char* name, void** value);
 ...
 * @return True; or false if a null pointer is passed.
 */
YAPI b8 hashtable_get(HASHTABLE* table, const char* name, void* out_value);
 ...
 */
YAPI b8 hashtable_get_ptr(HASHTABLE* table, const char* name, void** out_value);
 ...
 */
YAPI b8 hashtable_fill(HASHTABLE* table, void* value);