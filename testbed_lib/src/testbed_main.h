...
YAPI b8 application_update(struct APPLICATION* application_instance, struct FRAME_DATA* p_frame_data);

YAPI b8 application_render(struct APPLICATION* application_instance, struct RENDER_PACKET* packet, struct FRAME_DATA* p_frame_data);
